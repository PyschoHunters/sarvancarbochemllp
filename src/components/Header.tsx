  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {navigation.map((item) => (
                <Link
                  ...
                  to={item.href}
                  className={cn(
                    "px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 relative",
            ...
            <div className="hidden lg:flex items-center gap-4">
              <Link to="/contact">
                <Button variant="secondary" size="default" className="shadow-glow">
                  Get Quote
                </Button>
              </Link>
            </div>
        ...
        >
          <nav className="container mx-auto px-4 py-4 space-y-2 bg-white">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}
