        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <img src={logo} alt="Sarvan Carbochem Logo" className="h-14 w-auto bg-white rounded-lg p-1" />
              <div>
            ...
            <p className="text-primary-foreground/80 leading-relaxed text-sm">
              Technical marketing of Synthetic Rubbers and Rubber & Plastic Additives serving the Indian Rubber and Plastic Industries.
            </p>
            <div className="flex items-center gap-2 pt-2">
              <span className="w-2 h-2 bg-secondary rounded-full animate-pulse" />
              <span className="text-sm text-primary-foreground/70">Trusted since 2014, backed by a legacy since 1941</span>
            </div>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="flex items-center gap-2 text-primary-foreground/70 hover:text-secondary transition-colors group text-sm"
                  >
